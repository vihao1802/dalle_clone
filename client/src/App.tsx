...
const App = () => {
  ...
  return (
    <BrowserRouter>
      <div className="">
        <header className="w-full flex justify-between items-center bg-white sm:px8 px-4 py-4 border-b border-b-[#e6ebf4] dark:bg-[#1f4369f2] dark:border-b-[#111826]">
          <Link to="/">
      ...
      w-full bg-[#f9fafe] min-h-[calc(100vh-73px)] dark:bg-[#142f4d]"
        >
          <Routes>
